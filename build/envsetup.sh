...
reaper_append_hmm "reaperremote" "Add a git remote for matching Reaper repository"
reaper_append_hmm "slimremote" "Add a git remote for matching SLIM repository"
reaper_append_hmm "cmremote" "Add a git remote for matching CM repository"
reaper_append_hmm "aospremote" "Add git remote for matching AOSP repository"
reaper_append_hmm "cafremote" "Add git remote for matching CodeAurora repository."
